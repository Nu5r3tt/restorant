...
namespace RestaurantOrdering.Migrations
{
    ...
    [Migration("20250824121445_AddSupplierAndTaxRateTables")]
    partial class AddSupplierAndTaxRateTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantOrdering.Models.Stock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantOrdering.Models.StockMovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantOrdering.Models.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantOrdering.Models.TaxRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 21, 18, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Temel gıda maddeleri için KDV oranı",
                            IsActive = true,
                            Name = "KDV %1",
                            Rate = 1.00m
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 8, 21, 18, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Bazı gıda maddeleri için KDV oranı",
                            IsActive = true,
                            Name = "KDV %8",
                            Rate = 8.00m
                        },
                        ...
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 8, 21, 18, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Lüks ürünler için KDV oranı",
                            IsActive = true,
                            Name = "KDV %20",
                            Rate = 20.00m
                        });
            ...
            modelBuilder.Entity("RestaurantOrdering.Models.Stock", b =>
                {
                    b.HasOne("RestaurantOrdering.Models.Supplier", "Supplier")
                        .WithMany("Stocks")
                        .HasForeignKey("SupplierId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("RestaurantOrdering.Models.TaxRate", "TaxRate")
                        .WithMany("Stocks")
            ...
            modelBuilder.Entity("RestaurantOrdering.Models.StockMovement", b =>
                {
                    b.HasOne("RestaurantOrdering.Models.Stock", "Stock")
